...
function createHelpEmbed(client, me, member) {
    ...
    embed.addField("__Besoin de support plus poussé?__", "[Voici le site web source de ce bot](https://benji7425.github.io) or [Rejoindre le serveur officiel](https://discord.gg/SSkbwSJ)");
    return embed;
}
exports.default = new command_1.default(
/*syntax*/ "help", 
/*description*/ "Affiche les commande valable avec une description",
