...
async function invoke(_, message, client) {
    return new Promise(async (__, reject) => {
        const response = await new question_1.default(client, message.channelId, "Voulez-vous vraiment supprimer toutes les données de ce serveur? (oui/non)", message.member, true).send();
...
/*syntax*/ "reset",
/*description*/ "\n" +
    "Réinitialisez toutes les données de ce serveur Discord. ATTENTION: VOUS PERDREZ TOUS VOS PARAMÈTRES!",
